...
(function () {
    ...
    (function (global) {
        ...
        ss.isArrayOrTypedArray = function (obj) {
            return (
                ss.isArray(obj) || ss.isTypedArrayType(ss.getInstanceType(obj))
            );
        };
        ...
        ss.makeGenericType = function (genericType, typeArguments) {
            ...
            return (
                ss.__genericCache[
                    ss._makeQName(name, genericType.__assembly)
            ...
            if (metadata.variance) {
                type.isAssignableFrom = function (source) {
                    var check = function (target, type) {
                        if (
                            type.__genericTypeDefinition ===
                                target.__genericTypeDefinition &&
                            type.__typeArguments.length ===
                                target.__typeArguments.length
                        ) {
                            for (
                                var i = 0;
        ...
        var ss_IFormattable = (ss.IFormattable = ss.mkType(
            ss,
            "ss.IFormattable",
        ));
        ...
        ss.initClass(ss_ArrayEnumerator, null, [
            ss_IEnumerator,
            ss_IDisposable,
        ]);
        ...
        ss.initClass(ss_ObjectEnumerator, null, [
            ss_IEnumerator,
            ss_IDisposable,
        ]);
                ...
                toString: function () {
                    ...
                    if (ss.isNullOrEmptyString(message)) {
                        if (
                            ...
                            ss.isValue(
                                ss.getTypeFullName(
                                    ss.getInstanceType(exception),
                                ),
                            )
                        ) {
                            message = ss.getTypeFullName(
                                ss.getInstanceType(exception),
                            );
                        } else {
        ...
        var ss_NotImplementedException = (ss.NotImplementedException =
            ss.mkType(
                ss,
        ...
        var ss_AmbiguousMatchException = (ss.AmbiguousMatchException =
            ss.mkType(
                ss,
    ...
    (function () {
        ...
        var d = (global.tab.CookieHelper = ss.mkType(
            ...
            null,
            {
                ...
                deleteCookie: function (n, o) {
                    var p = new Date(0);
                    e.setCookie(
                        n + "=;path=" + o + ";expires=" + p.toUTCString(),
                    );
                },
            },
        ));
        ...
        var g = (global.tab.Log = ss.mkType(
            a,
            "tab.Log",
            function () {},
            null,
            ...
            },
            {
                ...
                filterByType: function (n, o) {
                    ...
                    i.$0(function (p, q) {
                        return (
                            q >= o &&
                            ss.referenceEquals(p.get_name(), ss.getTypeName(n))
                        );
                    });
                },
        ...
        (function () {
            ...
            }
            {
                ...
                for (
                    var s = 0;
                    s < p.length &&
                    (ss.isNullOrUndefined(q) || ss.isNullOrUndefined(r));
                    ++s
                ) {
                    var t = p[s];
    ...
    (function () {
        ...
        var r = (global.tab._Utility = ss.mkType(
            a,
            "tab._Utility",
            null,
            null,
            {
                ...
                isDate: function (e) {
                    if (
                        typeof e === "object" &&
                        ss.isInstanceOfType(e, ss.JsDate)
                    ) {
                        return true;
                    } else if (
                ...
                visibleContentRectInDocumentCoordinates: function (e) {
                    ...
                    for (
                        ...
                        if (
                            ...
                            bi = bi.intersect(
                                r.contentRectInDocumentCoordinates(bj),
                            );
                        }
                    }
                    var bl = r.$1();
                ...
                $1: function () {
                    ...
                    if (ss.isValue(e)) {
                        ...
                        var bi = r.contentRectInDocumentCoordinates(
            ...
            null,
            {
                convertDashboardObjectType: function (e) {
                    switch (e) {
                        ...
                        default: {
                            throw q.createInternalError(
                                "Unknown ApiCrossDomainDashboardObjectType: " +
                                    e,
                            );
                        }
                    }
                ...
                $1: function (e) {
                    ...
                    if (bj.get_isApiCommandName()) {
                        if (bj.get_commandId() === "xdomainSourceId") {
                            bl.handleEventNotification(
                                bj.get_name(),
                                bj.get_parameters(),
                            );
                            if (
                                bj.get_name() === "api.FirstVizSizeKnownEvent"
                            ) {
        ...
        var Q = (global.tab.DataValue = ss.mkType(
            a,
            "tab.DataValue",
            null,
            null,
        ...
        var R = (global.tab.FilterCommandsBuilder = ss.mkType(
            ...
            function () {},
            {
                buildApplyFiltersCommandParams: function (e, bi, bj, bk) {
                    ...
                    bn["api.exclude"] =
                        ss.isValue(bk) && bk.isExcludeMode ? true : false;
                    if (bj !== "all") {
                ...
                buildRangeFilterCommandParams: function (e, bi) {
                    ...
                    if (ss.isValue(bi.min)) {
                        if (r.isDate(bi.min)) {
                            var bk = bi.min;
                            if (r.isDateValid(bk)) {
                                bj["api.filterRangeMin"] =
                                    r.serializeDateForServer(bk);
                            } else {
                                throw q.createInvalidDateParameter(
                                    "filterOptions.min",
                                );
                            }
                        } else {
                    ...
                    if (ss.isValue(bi.max)) {
                        if (r.isDate(bi.max)) {
                            var bl = bi.max;
                            if (r.isDateValid(bl)) {
                                bj["api.filterRangeMax"] =
                                    r.serializeDateForServer(bl);
                            } else {
                                throw q.createInvalidDateParameter(
                                    "filterOptions.max",
                                );
                ...
                buildRelativeDateFilterCommandParams: function (e, bi) {
                    ...
                    if (ss.isValue(bi)) {
                        ...
                        if (ss.isValue(bi.anchorDate)) {
                            bj["api.filterDateArchorValue"] =
                                r.serializeDateForServer(bi.anchorDate);
                        }
                    }
                    return bj;
                },
                ...
                normalizeRelativeDateFilterOptions: function (e) {
                    ...
                    if (ss.isValue(e.anchorDate)) {
                        if (
                            !r.isDate(e.anchorDate) ||
                            !r.isDateValid(e.anchorDate)
                        ) {
                            throw q.createInvalidDateParameter(
                ...
                createFilterCommandReturnHandler: function (e, bi, bj) {
                    return new (ss.makeGenericType(N, [Object]))(
                        ...
                        function (bk, bl) {
                            if (bk) {
                                bj.reject(
                                    q.createInvalidFilterFieldNameOrValue(bi),
                                );
                            } else {
                                var bm = q.create(
        ...
        var S = (global.tab.GetDataCommandsBuilder = ss.mkType(
            ...
            function () {},
            {
                getSummaryDataCommandParams: function (e) {
                    var bi = {};
                    e = e || new Object();
                    bi["api.ignoreAliases"] = ss.coalesce(
                        e.ignoreAliases,
                        false,
                    );
                    bi["api.ignoreSelection"] = ss.coalesce(
                        e.ignoreSelection,
                        false,
                    );
                ...
                getUnderlyingDataCommandParams: function (e) {
                    ...
                    bi["api.includeAllColumns"] = ss.coalesce(
                        e.includeAllColumns,
                        false,
                    );
                    bi["api.maxRows"] = ss.coalesce(e.maxRows, 0);
                ...
                getUnderlyingTableDataCommandParams: function (e, bi) {
                    var bj = {};
                    bi = bi || new Object();
                    bj["api.ignoreAliases"] = ss.coalesce(
                        bi.ignoreAliases,
                        false,
                    );
                    bj["api.ignoreSelection"] = ss.coalesce(
                        bi.ignoreSelection,
                        false,
                    );
        ...
        var ba = (global.tab.SheetSize = ss.mkType(
            a,
            "tab.SheetSize",
            null,
            null,
    ...
    (function () {
        ...
        var i = ss.mkType(
            ...
            function (e) {
                ...
                this.$d = tab.ApiEnumConverter.convertParameterDataType(
                    e.dataType,
                );
                this.$b =
                ...
                if (this.$b === "range") {
                    ...
                    if (
                        ...
                        this.$e = tab.ApiEnumConverter.convertPeriodType(
                            e.dateStepPeriod,
                        );
                    }
                }
        ...
        var j = (global.tab._ApiBootstrap = ss.mkType(
            ...
            {
                initialize: function () {
                    tab._ApiObjectRegistry.registerApiMessageRouter(
                        function () {
                            return new D();
                        },
                    );
            ...
            },
            {
                ...
                _getCustomViewsAsync: function (e, bn) {
                    ...
                    var bp = new (ss.makeGenericType(
                        ...
                        function (bq, br) {
                            bo.reject(
                                tab._TableauException.create("serverError", br),
                            );
                        },
                    );
                ...
                $1: function (e, bn, bo, bp, bq) {
                    ...
                    var bv = bu.$5();
                    if (e.$d()._has(bv)) {
                        bv = k.buildCustomViewKeyForDuplicate(
                            bu.$5(),
                            bp.owner.username,
                        );
                    }
                ...
                $0: function (e, bn, bo) {
                    ...
                    return new (ss.makeGenericType(tab.CommandReturnHandler$1, [
                        Object,
                    ]))(e, 0, bo, bp);
                },
            },
            ...
            },
            {
                ...
                $e: function () {
                    ...
                    var bo = new (ss.makeGenericType(
                            ...
                            try {
                                while (bs.moveNext()) {
                                    ...
                                    for (
                                        var bu = 0;
                                        bu <
                                        this.get_worksheets().get__length();
                                        bu++
                                    ) {
                                        if (
                                            ss.referenceEquals(
                        ...
                        function (bp, bq) {
                            e.reject(
                                tab._TableauException.createServerError(bq),
                            );
                        },
                    );
                ...
                $d: function (e, bn, bo, bp) {
                    this.$f();
                    var bq = this.$i.buildApplyFiltersCommandParams(
                        e,
                        bn,
                        bo,
                        bp,
        ...
        var n = (global.tab._SheetImpl = ss.mkType(
            ...
            },
            {
                ...
                changeSizeAsync: function (e) {
                    ...
                    var bq = new (ss.makeGenericType(
                        ...
                        function (br, bs) {
                            bn.reject(
                                tab._TableauException.createServerError(bs),
                            );
                        },
                    );
            ...
            },
            {
                ...
                $1: function (e) {
                    var bn = tab.PublicEnums.normalizeEnum(
                        tab.ApiSheetSizeBehavior,
                    ).call(null, e.behavior, "size.behavior");
                    var bo = e.minSize;
                    if (ss.isValue(bo)) {
                        bo = tab.Size.$ctor(
                            n.$0(e.minSize.width),
                            n.$0(e.minSize.height),
                        );
                    }
                    var bp = e.maxSize;
                    if (ss.isValue(bp)) {
            ...
            },
            {
                ...
                update: function (e) {
                    ...
                    for (var bp = 0; bp < e.storyPoints.length; bp++) {
                        ...
                        if (ss.isNullOrUndefined(this.$j[bp])) {
                            ...
                            this.$j[bp]._impl.storyPointId === bt.storyPointId
                        ) {
                ...
                activateStoryPointAsync: function (e) {
                    ...
                    var bp = new (ss.makeGenericType(
                        ...
                        function (bq, br) {
                            bn.reject(
                                tab._TableauException.createServerError(br),
                            );
                        },
                    );
            ...
            function (e, bn) {
                ...
                if (ss.isValue(bn)) {
                    ...
                    if (bn.get_sheetType() === "dashboard") {
                        ...
                        for (
                            var bp = 0;
                            bp < bo.get_worksheets().get__length();
                            bp++
                        ) {
        ...
        var u = (global.tab._VizParameters = ss.mkType(
            ...
            },
            {
                ...
                $0: function () {
                    ...
                    if (
                        !(
                            this.userSuppliedParameters.indexOf(":embed=y") !==
                            -1
                        )
                    ) {
                        e.push(":embed=y");
                    ...
                    if (
                        ss.isValue(this.$2.navType) &&
                        this.$2.navType.length > 0
                    ) {
            ...
            },
            {
                ...
                _setActiveSheetAsync: function (e) {
                    if (tab._Utility.isNumber(e)) {
                        ...
                        if (bn < this.$A.get__length() && bn >= 0) {
                            ...
                            throw tab._TableauException.createIndexOutOfRange(
                                bn,
                            );
                        }
                    }
                ...
                _revertAllAsync: function () {
                    ...
                    var bn = new (ss.makeGenericType(
                        ...
                        function (bo, bp) {
                            e.reject(
                                tab._TableauException.createServerError(bp),
                            );
                        },
                    );
                ...
                $o: function (e) {
                    ...
                    if (
                        ss.isNullOrUndefined(bo) &&
                        ss.isNullOrUndefined(this.$r)
                    ) {
                        throw tab._TableauException.createInternalError(
                    ...
                    if (ss.isValue(this.$r)) {
                        ...
                        var bs = null;
                        for (
                            var bt = 0, bu = e.publishedSheets.length;
                            bt < bu;
                            bt++
                        ) {
                            if (
                                ss.referenceEquals(
                                    e.publishedSheets[bt].name,
                                    bn,
                                )
                            ) {
                ...
                $m: function (e) {
                    ...
                    for (var bo = 0; bo < bn.length; bo++) {
                        ...
                        if (ss.isNullOrUndefined(br)) {
                            ...
                            var bu = tab.ApiEnumConverter.convertSheetType(
                                bp.sheetType,
                            );
                            var bv = o.$ctor(
                                bq,
                ...
                $2: function (e, bn) {
                    ...
                    if (ss.isValue(this.$z)) {
                        if (ss.isNullOrUndefined(this.$z._get(e))) {
                            bo.reject(
                                tab._TableauException.createInvalidParameter(e),
                            );
                            return bo.get_promise();
                        }
                    ...
                    var bq = {};
                    bq["api.setParameterName"] = ss.isValue(this.$z)
                        ? bp.$7()
                        : e;
                    if (ss.isValue(bn) && tab._Utility.isDate(bn)) {
                        ...
                        bq["api.setParameterValue"] = ss.isValue(bn)
                            ? bn.toString()
                            : null;
                    }
                    this.$w = null;
                    var bt = new (ss.makeGenericType(
                        tab.CommandReturnHandler$1,
                        [Object],
                    ))(
                        ...
                        ss.mkdel(this, function (bu) {
                            ...
                            if (!bu.isValidPresModel) {
                                bo.reject(
                                    tab._TableauException.createInvalidParameter(
                                        e,
                                    ),
                                );
                                return;
            ...
            },
            {
                $0: function (e) {
                    ...
                    for (var bo = 0; bo < e.length; bo++) {
                        var bp = e[bo];
                        var bq =
                            tab.ApiEnumConverter.convertDashboardObjectType(
                                bp.zoneType,
                            );
            ...
            },
            {
                ...
                $z: function (e) {
                    if (ss.isValue(this.get_parentStoryPointImpl())) {
                        ...
                        bn.dashboard = ss.isValue(
                            this.get_parentDashboardImpl(),
                        )
                            ? this.$Q.get_name()
                            : this.get_name();
                ...
                $m: function (e, bn, bo) {
                    ...
                    var br = new (ss.makeGenericType(
                        ...
                        function (bs, bt) {
                            bp.reject(
                                tab._TableauException.createServerError(bt),
                            );
                        },
                    );
                ...
                $x: function (e, bn, bo, bp) {
                    ...
                    var br = ss.mkdel(this, function (bt) {
                        ...
                        if (!ss.contains(e, bv)) {
                            ...
                            bq.reject(
                                tab._TableauException.createInternalError(bA),
                            );
                            return;
                        }
                        for (var bB = 0; bB < e.length; bB++) {
                            ...
                            if (!ss.contains(bw, bC) && !ss.contains(bx, bC)) {
                                var bD =
                                    ...
                                    bC;
                                bq.reject(
                                    tab._TableauException.createInternalError(
                                        bD,
                                    ),
                                );
                                return;
                        ...
                        var bG = function (bI, bJ) {
                            bq.reject(
                                tab._TableauException.createServerError(bJ),
                            );
                        };
                        var bH = new (ss.makeGenericType(
                            tab.CommandReturnHandler$1,
                            [Object],
                ...
                $A: function (e, bn, bo, bp) {
                    this.$L();
                    var bq = new tab._Deferred();
                    var br = this.$N.buildApplyFiltersCommandParams(
                        e,
                        bn,
                        bo,
                        bp,
                ...
                $D: function (e, bn) {
                    this.$L();
                    var bo = this.$N.buildRelativeDateFilterCommandParams(
                        e,
                        bn,
                    );
                    this.$z(bo);
                ...
                $B: function (e, bn, bo, bp) {
                    this.$L();
                    var bq = this.$N.buildHierarchicalFilterCommandParams(
                        e,
                        bn,
                        bo,
                        bp,
                ...
                $G: function (e, bn, bo, bp, bq, br, bs, bt) {
                    ...
                    if (w.$3.test(bs)) {
                        ...
                        if (ss.isValue(bu.min)) {
                            if (tab._Utility.isDate(bu.min)) {
                                ...
                                if (tab._Utility.isDateValid(bw)) {
                                    bv.min =
                                        tab._Utility.serializeDateForServer(bw);
                                } else {
                        ...
                        if (ss.isValue(bu.max)) {
                            if (tab._Utility.isDate(bu.max)) {
                                ...
                                if (tab._Utility.isDateValid(bx)) {
                                    bv.max =
                                        tab._Utility.serializeDateForServer(bx);
                                } else {
                                    throw tab._TableauException.createInvalidDateParameter(
                                        "options.max",
                                    );
                        ...
                        if (ss.isValue(bu.nullOption)) {
                            var by = tab.PublicEnums.normalizeEnum(
                                tab.ApiNullOption,
                            ).call(null, bu.nullOption, "options.nullOption");
                            bv.nullOption = by;
                        } else {
                ...
                $K: function (e, bn, bo, bp, bq, br, bs, bt) {
                    var bu = {};
                    this.$z(bu);
                    bt = tab.PublicEnums.normalizeEnum(
                        tab.ApiSelectionUpdateType,
                    ).call(null, bt, "updateType");
                    ...
                    if (
                        ...
                        tab._Utility.isNullOrEmpty(
                            bu["api.categoricalFieldCaption"],
                        ) &&
                        tab._Utility.isNullOrEmpty(
                            bu["api.hierarchicalFieldCaption"],
                        ) &&
                    ...
                    var bF = new (ss.makeGenericType(
                        ...
                        function (bG, bH) {
                            bE.reject(
                                tab._TableauException.createServerError(bH),
                            );
                        },
                    );
                ...
                $o: function () {
                    ...
                    var bo = new (ss.makeGenericType(
                        ...
                        0,
                        ss.mkdel(this, function (bp) {
                            this.highlightedMarks =
                                tab.MarkImpl.processActiveMarks(bp);
                ...
                $0: function (e) {
                    ...
                    if (ss.isValue(bn) && ss.isValue(bn.errorCode)) {
                        ...
                        switch (bn.errorCode) {
                            ...
                            default: {
                                return tab._TableauException.createServerError(
                                    bo,
                                );
                            }
                        }
            ...
            },
            {
                ...
                sendCommand: function (e) {
                    return function (bn, bo, bp) {
                        ...
                        if (
                            bp.get_commandName() === "api.ShowCustomViewCommand"
                        ) {
            ...
            },
            {
                ...
                getCurrentUrlAsync: function () {
                    ...
                    var bn = new (ss.makeGenericType(
                        ...
                        function (bo, bp) {
                            e.reject(
                                tab._TableauException.createInternalError(bp),
                            );
                        },
                    );
                ...
                addEventListener: function (e, bn) {
                    var bo = {};
                    if (
                        !tab.PublicEnums.tryNormalizeEnum(
                            tab.ApiTableauEventName,
                        ).call(null, e, bo)
                    ) {
                ...
                $e: function () {
                    ...
                    var e =
                        tab._Utility.visibleContentRectInDocumentCoordinates(
                            this.get_iframe(),
                        );
                    ...
                    this.get__workbookImpl()._update(
                        ss.mkdel(this, function () {
                            if (!ss.staticEquals(this.$1$8, null)) {
                                this.$1$8(
                                    new x("customviewsave", this.$1u, e._impl),
                                );
                            }
                        }),
                    );
                ...
                $18: function (e) {
                    if (!ss.staticEquals(this.$1$10, null)) {
                        this.$1$10(
                            new x("customviewsetdefault", this.$1u, e._impl),
                        );
                    }
                },
                $1b: function (e, bn) {
                ...
                $T: function (e) {
                    ...
                    if (
                        ss.referenceEquals(bo.get_name(), e.get_worksheetName())
                    ) {
                        bn = bo;
                ...
                $I: function () {
                    ...
                    if (ss.isValue(window.navigator.language)) {
                        ...
                        ss.isValue(window.navigator["browserLanguage"])
                    ) {
                ...
                $R: function (e) {
                    var bn = tab.SheetSizeFactory.fromSizeConstraints(
                        e.sizeConstraints,
                    );
                    this.$1v = P.$ctor(bn, e.chromeHeight);
                    if (ss.isValue(this.$1r)) {
                        this.$1r(
                            new A("firstvizsizeknown", this.$1u, this.$1v),
                        );
                    }
                    if (this.$1s.fixedSize) {
                        return;
        ...
        var X = (global.tableauSoftware.Filter = ss.mkType(
            ...
            },
            {
                ...
                $0: function (e) {
                    this.$5 = e.fieldName;
                    this.$4 = e.caption;
                    this.$7 = tab.ApiEnumConverter.convertFilterType(
                        e.filterType,
                    );
                    this.$2 = null;
